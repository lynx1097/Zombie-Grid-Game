...
/**
 * Abstract hero character. Extends {@link Character} with an action-point
 * economy, vaccine and supply inventories, and hero-specific actions:
 * {@link #move}, {@link #attack}, {@link #cure}, and {@link #useSpecial}.
 *
 * <p>Each subclass ({@link Fighter}, {@link Medic}, {@link Explorer}) overrides
 * {@link #useSpecial()} to provide a distinct role ability.</p>
 */
public abstract class Hero extends Character {
	...
	public void move(Direction d) throws MovementException, NotEnoughActionsException {
		...
		if (Game.map[tX][tY] instanceof CharacterCell && ((CharacterCell) Game.map[tX][tY]).getCharacter() != null)
			...
			Alert alert = new Alert(Alert.AlertType.INFORMATION, "Ooops , you stepped into a trap .");
			alert.show();
		}
